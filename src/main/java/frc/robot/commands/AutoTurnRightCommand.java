...
public class AutoTurnRightCommand extends CommandBase {
  ...
  public AutoTurnRightCommand(int Encoder, double speed) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(RobotContainer.m_DriveSubsystem);
  ...
  public AutoTurnRightCommand(int Encoder, double speed, double f) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(RobotContainer.m_DriveSubsystem);
    FinalEncoderValue = Encoder;
    RobotSpeed = speed;
  ...
  public boolean isFinished() {
    return (Math.abs(DriveSubsystem.leftEncoder.getPosition()) >= FinalEncoderValue);
  }
}
